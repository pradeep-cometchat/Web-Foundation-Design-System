...
export const Default: StoryObj = {
  render: () => (
    <div style={{ padding: 40, textAlign: "center", color: "var(--color-neutral-600, #535862)" }}>
      <h2 style={{ margin: 0, fontSize: 20, fontWeight: 600, color: "var(--color-neutral-900, #181d27)" }}>Dropdown</h2>
      <p style={{ marginTop: 8, fontSize: 14 }}>Select menus with search, multi-select, and custom rendering.</p>
