 ...
 */
const meta: Meta = {
  title: "Core Components/Message Composer/Single Line Composer/State",
  tags: ["autodocs"],
...
function SingleLineComposer({ state, text }: { state: "placeholder" | "focus" | "typing"; text?: string }) {
    ...
    <div style={composerRow}>
      ...
      <div style={inputInline}>
        {state === "typing" && text ? (
          ...
          <span style={{ color: "var(--color-text-placeholder-subtle)", display: "flex", alignItems: "center" }}>
            <span style={{ display: "inline-block", width: 1.5, height: 18, background: "var(--color-text-primary)", marginRight: 2 }} />
            Enter your message here
          </span>
        ) : (
          <span style={{ color: "var(--color-text-placeholder)" }}>Enter your message here</span>
        )}
      </div>
...
export const Placeholder: Story = {
  parameters: { controls: { disable: true }, layout: "padded" },
  render: () => <div style={{ padding: 24 }}><SingleLineComposer state="placeholder" /></div>,
};

/** Focus state — input is focused, ready for typing. */
export const Focus: Story = {
  parameters: { controls: { disable: true }, layout: "padded" },
  render: () => <div style={{ padding: 24 }}><SingleLineComposer state="focus" /></div>,
};

/** Typing state — user has entered text, send button becomes active. */
export const Typing: Story = {
  parameters: { controls: { disable: true }, layout: "padded" },
  render: () => <div style={{ padding: 24 }}><SingleLineComposer state="typing" text="Hey!" /></div>,
};
