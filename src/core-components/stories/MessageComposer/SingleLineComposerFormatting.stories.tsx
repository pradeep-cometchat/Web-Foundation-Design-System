 ...
 */
const meta: Meta = {
  title: "Core Components/Message Composer/Single Line Composer/Formatting",
  tags: ["autodocs"],
...
function FormatToolbarRow({ active }: { active?: FormattingType }) {
  return (
    <div style={formatToolbar}>
      <button style={active === "bold" ? fmtBtnActive : fmtBtn} aria-label="Bold"><span style={{ fontWeight: 700 }}>B</span></button>
      <button style={active === "italic" ? fmtBtnActive : fmtBtn} aria-label="Italic"><span style={{ fontStyle: "italic" }}>I</span></button>
      <button style={active === "underline" ? fmtBtnActive : fmtBtn} aria-label="Underline"><span style={{ textDecoration: "underline" }}>U</span></button>
