import{j as o}from"./jsx-runtime-BYYWji4R.js";import{C as T}from"./ConfirmationDialog-nKBIVOvl.js";import"./index-ClcD9ViR.js";import"./_commonjsHelpers-Cpj98o6Y.js";const E={title:"Base Components/Dialog/Confirmation Dialogs/Block User",component:T,parameters:{layout:"centered"},decorators:[n=>o.jsx(B,{children:o.jsx(n,{})})]};function B({children:n}){return o.jsxs("div",{className:"dialog-story-inline",children:[o.jsx("style",{children:".dialog-story-inline .confirmation-dialog__overlay { position: relative !important; inset: unset !important; background: transparent !important; z-index: unset !important; }"}),n]})}const a={args:{variant:"blockUser"}},t={name:"Custom Title",args:{variant:"blockUser",title:"Block @john_doe?"}},r={name:"Custom Description",args:{variant:"blockUser",description:"Blocking this user will prevent them from sending you messages, seeing your online status, or adding you to groups."}},e={name:"Custom Labels",args:{variant:"blockUser",confirmLabel:"Yes, Block",cancelLabel:"Go Back"}},i={args:{variant:"blockUser",open:!0},parameters:{docs:{disable:!0}},argTypes:{title:{control:"text"},description:{control:"text"},confirmLabel:{control:"text"},cancelLabel:{control:"text"},open:{control:"boolean"}}},c={parameters:{controls:{disable:!0},layout:"fullscreen"},render:()=>o.jsxs("div",{style:{padding:"var(--cometchat-spacing-8)",maxWidth:1200,margin:"0 auto",display:"flex",flexDirection:"column",gap:"var(--cometchat-spacing-6)"},children:[o.jsx(l,{title:"HTML",children:o.jsx(d,{language:"HTML",code:`<div class="confirmation-dialog__overlay">
...
}`,...(u=(g=a.parameters)==null?void 0:g.docs)==null?void 0:u.source}}};var p,f,h;t.parameters={...t.parameters,docs:{...(p=t.parameters)==null?void 0:p.docs,source:{originalSource:`{
  name: "Custom Title",
  args: {
    variant: "blockUser",
    title: "Block @john_doe?"
  }
}`,...(h=(f=t.parameters)==null?void 0:f.docs)==null?void 0:h.source}}};var v,b,x;r.parameters={...r.parameters,docs:{...(v=r.parameters)==null?void 0:v.docs,source:{originalSource:`{
...
}`,...(x=(b=r.parameters)==null?void 0:b.docs)==null?void 0:x.source}}};var _,y,k;e.parameters={...e.parameters,docs:{...(_=e.parameters)==null?void 0:_.docs,source:{originalSource:`{
  name: "Custom Labels",
  args: {
    variant: "blockUser",
...
}`,...(k=(y=e.parameters)==null?void 0:y.docs)==null?void 0:k.source}}};var C,S,j;i.parameters={...i.parameters,docs:{...(C=i.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    variant: "blockUser",
    open: true
  },
...
}`,...(j=(S=i.parameters)==null?void 0:S.docs)==null?void 0:j.source}}};var w,U,L;c.parameters={...c.parameters,docs:{...(w=c.parameters)==null?void 0:w.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    },
...
}`,...(L=(U=c.parameters)==null?void 0:U.docs)==null?void 0:L.source}}};const G=["Default","CustomTitle","CustomDescription","CustomLabels","Playground","Usage"];export{r as CustomDescription,e as CustomLabels,t as CustomTitle,a as Default,i as Playground,c as Usage,G as __namedExportsOrder,E as default};
