import{j as o}from"./jsx-runtime-BYYWji4R.js";import{C as L}from"./ConfirmationDialog-CzHJ7xWO.js";import"./index-ClcD9ViR.js";import"./_commonjsHelpers-Cpj98o6Y.js";const B={title:"Base Components/Dialog/Confirmation Dialogs/Kick Member",component:L,parameters:{layout:"centered"},decorators:[n=>o.jsx(D,{children:o.jsx(n,{})})]};function D({children:n}){return o.jsxs("div",{className:"dialog-story-inline",children:[o.jsx("style",{children:".dialog-story-inline .confirmation-dialog__overlay { position: relative !important; inset: unset !important; background: transparent !important; z-index: unset !important; }"}),n]})}const a={args:{variant:"kickMember"}},e={name:"Custom Title",args:{variant:"kickMember",title:"Remove from Design Team?"}},t={name:"Custom Description",args:{variant:"kickMember",description:"This member will be removed from the group but can rejoin if they have an invite link. Their previous messages will remain."}},r={name:"Custom Labels",args:{variant:"kickMember",confirmLabel:"Remove Member",cancelLabel:"Keep in Group"}},i={args:{variant:"kickMember",open:!0},parameters:{docs:{disable:!0}},argTypes:{title:{control:"text"},description:{control:"text"},confirmLabel:{control:"text"},cancelLabel:{control:"text"},open:{control:"boolean"}}},c={parameters:{controls:{disable:!0},layout:"fullscreen"},render:()=>o.jsxs("div",{style:{padding:"var(--cometchat-spacing-8)",maxWidth:1200,margin:"0 auto",display:"flex",flexDirection:"column",gap:"var(--cometchat-spacing-6)"},children:[o.jsx(l,{title:"HTML",children:o.jsx(d,{language:"HTML",code:`<div class="confirmation-dialog__overlay">
...
}`,...(u=(g=a.parameters)==null?void 0:g.docs)==null?void 0:u.source}}};var p,f,h;e.parameters={...e.parameters,docs:{...(p=e.parameters)==null?void 0:p.docs,source:{originalSource:`{
  name: "Custom Title",
  args: {
    variant: "kickMember",
    title: "Remove from Design Team?"
  }
}`,...(h=(f=e.parameters)==null?void 0:f.docs)==null?void 0:h.source}}};var v,b,x;t.parameters={...t.parameters,docs:{...(v=t.parameters)==null?void 0:v.docs,source:{originalSource:`{
...
}`,...(x=(b=t.parameters)==null?void 0:b.docs)==null?void 0:x.source}}};var _,y,k;r.parameters={...r.parameters,docs:{...(_=r.parameters)==null?void 0:_.docs,source:{originalSource:`{
  name: "Custom Labels",
  args: {
    variant: "kickMember",
...
}`,...(k=(y=r.parameters)==null?void 0:y.docs)==null?void 0:k.source}}};var C,S,j;i.parameters={...i.parameters,docs:{...(C=i.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    variant: "kickMember",
    open: true
  },
...
}`,...(j=(S=i.parameters)==null?void 0:S.docs)==null?void 0:j.source}}};var w,T,M;c.parameters={...c.parameters,docs:{...(w=c.parameters)==null?void 0:w.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    },
...
}`,...(M=(T=c.parameters)==null?void 0:T.docs)==null?void 0:M.source}}};const H=["Default","CustomTitle","CustomDescription","CustomLabels","Playground","Usage"];export{t as CustomDescription,r as CustomLabels,e as CustomTitle,a as Default,i as Playground,c as Usage,H as __namedExportsOrder,B as default};
