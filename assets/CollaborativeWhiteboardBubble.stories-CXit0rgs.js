import{j as e}from"./jsx-runtime-BYYWji4R.js";/* empty css                    */import"./index-ClcD9ViR.js";import"./_commonjsHelpers-Cpj98o6Y.js";const Z={title:"Core Components/Chat Bubbles/Collaborative Whiteboard Bubble",tags:["autodocs"],parameters:{layout:"centered"}},l={name:"Sent — Default",parameters:{docs:{description:{story:"Outgoing collaborative whiteboard bubble with read receipt."}}},render:()=>e.jsx(u,{children:e.jsx(o,{variant:"sent",status:"read",time:"4:56 pm"})})},d={name:"Sent — Delivered",parameters:{docs:{description:{story:"Outgoing collaborative whiteboard bubble with delivered status."}}},render:()=>e.jsx(u,{children:e.jsx(o,{variant:"sent",status:"delivered",time:"4:56 pm"})})},b={name:"Sent — Sent",parameters:{docs:{description:{story:"Outgoing collaborative whiteboard bubble with sent status."}}},render:()=>e.jsx(u,{children:e.jsx(o,{variant:"sent",status:"sent",time:"4:56 pm"})})},p={name:"Received — Default",parameters:{docs:{description:{story:"Incoming collaborative whiteboard bubble."}}},render:()=>e.jsx(u,{children:e.jsx(o,{variant:"received",time:"4:56 pm"})})},h={name:"All Variants",parameters:{layout:"padded"},render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--cometchat-spacing-6)",width:340,padding:"var(--cometchat-spacing-4)"},children:[e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--cometchat-spacing-2)"},children:[e.jsx(g,{children:"Sent — Read"}),e.jsx(o,{variant:"sent",status:"read",time:"4:56 pm"})]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--cometchat-spacing-2)"},children:[e.jsx(g,{children:"Received"}),e.jsx(o,{variant:"received",time:"4:56 pm"})]})]})},m={parameters:{controls:{disable:!0},layout:"fullscreen"},render:()=>e.jsxs("div",{style:{padding:"var(--cometchat-spacing-8)",maxWidth:1200,margin:"0 auto"},children:[e.jsx(c,{title:"HTML Structure",children:e.jsx(G,{language:"HTML",code:`<!-- Sent Collaborative Whiteboard Bubble -->
...
}`,...(f=(x=l.parameters)==null?void 0:x.docs)==null?void 0:f.source}}};var w,y,j;d.parameters={...d.parameters,docs:{...(w=d.parameters)==null?void 0:w.docs,source:{originalSource:`{
  name: "Sent — Delivered",
  parameters: {
    docs: {
      description: {
...
}`,...(j=(y=d.parameters)==null?void 0:y.docs)==null?void 0:j.source}}};var S,C,W;b.parameters={...b.parameters,docs:{...(S=b.parameters)==null?void 0:S.docs,source:{originalSource:`{
  name: "Sent — Sent",
  parameters: {
    docs: {
      description: {
...
}`,...(R=(D=h.parameters)==null?void 0:D.docs)==null?void 0:R.source}}};var T,O,U;m.parameters={...m.parameters,docs:{...(T=m.parameters)==null?void 0:T.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    },
...
}`,...(U=(O=m.parameters)==null?void 0:O.docs)==null?void 0:U.source}}};var z,A,I,P,V;s.parameters={...s.parameters,docs:{...(z=s.parameters)==null?void 0:z.docs,source:{originalSource:`{
  parameters: {
    docs: {
      disable: true
    }
  }
}`,...(I=(A=s.parameters)==null?void 0:A.docs)==null?void 0:I.source},description:{story:"Interactive playground.",...(V=(P=s.parameters)==null?void 0:P.docs)==null?void 0:V.description}}};const X=["SentDefault","SentDelivered","SentSent","ReceivedDefault","AllVariants","Usage","Playground"];export{h as AllVariants,s as Playground,p as ReceivedDefault,l as SentDefault,d as SentDelivered,b as SentSent,m as Usage,X as __namedExportsOrder,Z as default};
