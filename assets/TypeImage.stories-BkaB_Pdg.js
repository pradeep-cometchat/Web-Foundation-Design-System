import{j as e}from"./jsx-runtime-BYYWji4R.js";import{b as L,S as l,R as c,I as r,c as i,e as g,M as t,P as p,f as v,g as h,h as H,k as U,a as b,l as q,U as G}from"./_shared-gpEOlAGR.js";import"./index-ClcD9ViR.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./SearchBar-C2XVB5CY.js";/* empty css                  */const Q={title:"Core Components/Message Composer/Multi Attachments/Types/Image",tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`**Image attachment — all states.** Image files across every surface: queued
in the composer (loading → default → hover → remove → error), delivered in a
message (single, grids, "+N" overflow, uploading, failed), and in search.`}}}},s={name:"In Composer",parameters:{controls:{disable:!0}},render:()=>e.jsxs("div",{style:{padding:"var(--cometchat-spacing-6)"},children:[e.jsx(L,{}),e.jsx(l,{title:"In Composer",children:e.jsxs(c,{gap:24,children:[e.jsx(r,{label:"Loading",children:e.jsx(i,{badge:"loading"})}),e.jsx(r,{label:"Default",children:e.jsx(i,{badge:"none"})}),e.jsx(r,{label:"Hover",children:e.jsx(i,{badge:"hover"})}),e.jsx(r,{label:"Remove",children:e.jsx(i,{badge:"remove"})}),e.jsx(r,{label:"Error",children:e.jsx(i,{badge:"error"})})]})})]})},n={name:"In Message",parameters:{controls:{disable:!0}},render:()=>e.jsxs("div",{style:{padding:"var(--cometchat-spacing-6)"},children:[e.jsx(L,{}),e.jsxs(c,{gap:24,children:[["sent","received"].map(a=>e.jsxs(g,{width:320,children:[e.jsx(r,{label:`${a} · single`,children:e.jsx(t,{variant:a,images:1})}),e.jsx(r,{label:`${a} · 2 grid`,children:e.jsx(t,{variant:a,images:2})}),e.jsx(r,{label:`${a} · 3 grid`,children:e.jsx(t,{variant:a,images:3})}),e.jsx(r,{label:`${a} · 4 grid`,children:e.jsx(t,{variant:a,images:4})}),e.jsx(r,{label:`${a} · 4+ overflow`,children:e.jsx(t,{variant:a,images:4,totalImages:9})})]},a)),e.jsxs(g,{width:320,children:[e.jsx(r,{label:"uploading",children:e.jsx(t,{variant:"sent",images:4,state:"uploading"})}),e.jsx(r,{label:"failed",children:e.jsx(t,{variant:"sent",images:2,state:"failed"})})]})]})]})},o={name:"In Search",parameters:{controls:{disable:!0}},render:()=>e.jsx("div",{style:{padding:"var(--cometchat-spacing-6)"},children:e.jsxs(c,{gap:24,children:[e.jsx(l,{title:"Media grid",children:e.jsxs(p,{children:[e.jsx(v,{value:"review",active:"Photos"}),e.jsx(h,{}),e.jsx(H,{children:"Photos"}),e.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(3, 1fr)",gap:"var(--cometchat-spacing-1-5)"},children:Array.from({length:6}).map((a,m)=>e.jsx(U,{src:b[m%b.length]},m))})]})}),e.jsx(l,{title:"Conversation result",children:e.jsxs(p,{children:[e.jsx(v,{value:"review",active:"All"}),e.jsx(h,{}),e.jsx(q,{name:"Design Team",time:"4:56 pm",count:5,hue:250})]})})]})})},d={parameters:{controls:{disable:!0},layout:"fullscreen"},render:()=>e.jsx(G,{composed:[{name:"ImagePreview",desc:"Composer thumbnail with the single-slot corner badge (remove / loading / error)."},{name:"MultiAttachmentBubble",desc:"Delivered image grid (1–4 tiles + “+N” overflow) with time + read receipt."},{name:"SearchBar",desc:"Design-system search input used by the Photos filter."},{name:"MediaTile",desc:"Square media-grid result tile in search."}],html:`<!-- Composer preview -->
...
.ma-tile { aspect-ratio: 1 / 1; border-radius: var(--cometchat-radius-2); overflow: hidden; }`})};var u,x,j,w,I;s.parameters={...s.parameters,docs:{...(u=s.parameters)==null?void 0:u.docs,source:{originalSource:`{
  name: "In Composer",
  parameters: {
    controls: {
      disable: true
...
}`,...(j=(x=s.parameters)==null?void 0:x.docs)==null?void 0:j.source},description:{story:"Composer preview — every badge state.",...(I=(w=s.parameters)==null?void 0:w.docs)==null?void 0:I.description}}};var f,S,y,C,M;n.parameters={...n.parameters,docs:{...(f=n.parameters)==null?void 0:f.docs,source:{originalSource:`{
  name: "In Message",
  parameters: {
    controls: {
      disable: true
...
}`,...(y=(S=n.parameters)==null?void 0:S.docs)==null?void 0:y.source},description:{story:"Delivered — single, grids and overflow, sent and received.",...(M=(C=n.parameters)==null?void 0:C.docs)==null?void 0:M.description}}};var _,P,A,R,D;o.parameters={...o.parameters,docs:{...(_=o.parameters)==null?void 0:_.docs,source:{originalSource:`{
  name: "In Search",
  parameters: {
    controls: {
      disable: true
