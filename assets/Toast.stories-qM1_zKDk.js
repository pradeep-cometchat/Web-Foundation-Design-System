...
- Text: Caption 1/Regular — 12px, weight 400, line-height 18px, white, centered`}}},argTypes:{message:{control:"text",description:"The message to display."},open:{control:"boolean",description:"Whether the toast is visible."},duration:{control:{type:"number",min:0,step:500},description:"Auto-dismiss duration in ms. 0 to disable."},onClose:{control:!1}}},a={args:{message:"Message Copied",open:!0,duration:0}},r={args:{message:"Message Sent",open:!0,duration:0}},t={args:{message:"Message Deleted",open:!0,duration:0}},n={args:{message:"Link Copied",open:!0,duration:0}},o={args:{message:"Your message has been forwarded successfully",open:!0,duration:0}},i={parameters:{layout:"padded"},render:()=>e.jsxs("div",{style:{display:"flex",gap:"var(--space-4)",flexWrap:"wrap",justifyContent:"center",alignItems:"center",padding:"var(--space-10)"},children:[e.jsx(s,{message:"Message Copied",open:!0,duration:0}),e.jsx(s,{message:"Message Sent",open:!0,duration:0}),e.jsx(s,{message:"Message Deleted",open:!0,duration:0}),e.jsx(s,{message:"Link Copied",open:!0,duration:0}),e.jsx(s,{message:"Reaction Added",open:!0,duration:0})]})},d={args:{message:"Message Copied",open:!0,duration:0},parameters:{docs:{disable:!0}}};var g,l,f,y,x;a.parameters={...a.parameters,docs:{...(g=a.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
    message: "Message Copied",
    open: true,
    duration: 0
  }
}`,...(f=(l=a.parameters)==null?void 0:l.docs)==null?void 0:f.source},description:{story:"Default state — exact match to Figma node 4090:837860.",...(x=(y=a.parameters)==null?void 0:y.docs)==null?void 0:x.description}}};var h,M,b,v,S;r.parameters={...r.parameters,docs:{...(h=r.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    message: "Message Sent",
    open: true,
    duration: 0
  }
}`,...(b=(M=r.parameters)==null?void 0:M.docs)==null?void 0:b.source},description:{story:"Message sent confirmation.",...(S=(v=r.parameters)==null?void 0:v.docs)==null?void 0:S.description}}};var C,T,_,j,k;t.parameters={...t.parameters,docs:{...(C=t.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    message: "Message Deleted",
    open: true,
    duration: 0
  }
}`,...(_=(T=t.parameters)==null?void 0:T.docs)==null?void 0:_.source},description:{story:"Message deleted confirmation.",...(k=(j=t.parameters)==null?void 0:j.docs)==null?void 0:k.description}}};var w,D,L,A,N;n.parameters={...n.parameters,docs:{...(w=n.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    message: "Link Copied",
    open: true,
    duration: 0
