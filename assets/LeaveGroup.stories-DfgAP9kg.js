import{j as o}from"./jsx-runtime-BYYWji4R.js";import{C as G}from"./ConfirmationDialog-CzHJ7xWO.js";import"./index-ClcD9ViR.js";import"./_commonjsHelpers-Cpj98o6Y.js";const H={title:"Base Components/Dialog/Confirmation Dialogs/Leave Group",component:G,parameters:{layout:"centered"},decorators:[n=>o.jsx(D,{children:o.jsx(n,{})})]};function D({children:n}){return o.jsxs("div",{className:"dialog-story-inline",children:[o.jsx("style",{children:".dialog-story-inline .confirmation-dialog__overlay { position: relative !important; inset: unset !important; background: transparent !important; z-index: unset !important; }"}),n]})}const a={args:{variant:"leaveGroup"}},t={name:"Custom Title",args:{variant:"leaveGroup",title:"Leave Project Alpha?"}},r={name:"Custom Description",args:{variant:"leaveGroup",description:"You will no longer receive messages from this group. You can rejoin later if the group is public or if you receive a new invite."}},e={name:"Custom Labels",args:{variant:"leaveGroup",confirmLabel:"Leave Group",cancelLabel:"Stay"}},i={args:{variant:"leaveGroup",open:!0},parameters:{docs:{disable:!0}},argTypes:{title:{control:"text"},description:{control:"text"},confirmLabel:{control:"text"},cancelLabel:{control:"text"},open:{control:"boolean"}}},c={parameters:{controls:{disable:!0},layout:"fullscreen"},render:()=>o.jsxs("div",{style:{padding:"var(--cometchat-spacing-8)",maxWidth:1200,margin:"0 auto",display:"flex",flexDirection:"column",gap:"var(--cometchat-spacing-6)"},children:[o.jsx(l,{title:"HTML",children:o.jsx(d,{language:"HTML",code:`<div class="confirmation-dialog__overlay">
...
}`,...(u=(g=a.parameters)==null?void 0:g.docs)==null?void 0:u.source}}};var p,f,v;t.parameters={...t.parameters,docs:{...(p=t.parameters)==null?void 0:p.docs,source:{originalSource:`{
  name: "Custom Title",
  args: {
    variant: "leaveGroup",
    title: "Leave Project Alpha?"
  }
}`,...(v=(f=t.parameters)==null?void 0:f.docs)==null?void 0:v.source}}};var h,x,b;r.parameters={...r.parameters,docs:{...(h=r.parameters)==null?void 0:h.docs,source:{originalSource:`{
...
}`,...(b=(x=r.parameters)==null?void 0:x.docs)==null?void 0:b.source}}};var _,y,C;e.parameters={...e.parameters,docs:{...(_=e.parameters)==null?void 0:_.docs,source:{originalSource:`{
  name: "Custom Labels",
  args: {
    variant: "leaveGroup",
...
}`,...(C=(y=e.parameters)==null?void 0:y.docs)==null?void 0:C.source}}};var S,j,k;i.parameters={...i.parameters,docs:{...(S=i.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    variant: "leaveGroup",
    open: true
  },
...
}`,...(k=(j=i.parameters)==null?void 0:j.docs)==null?void 0:k.source}}};var w,L,T;c.parameters={...c.parameters,docs:{...(w=c.parameters)==null?void 0:w.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    },
...
}`,...(T=(L=c.parameters)==null?void 0:L.docs)==null?void 0:T.source}}};const A=["Default","CustomTitle","CustomDescription","CustomLabels","Playground","Usage"];export{r as CustomDescription,e as CustomLabels,t as CustomTitle,a as Default,i as Playground,c as Usage,A as __namedExportsOrder,H as default};
