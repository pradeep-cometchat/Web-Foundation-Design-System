import{j as e}from"./jsx-runtime-BYYWji4R.js";/* empty css                    */import"./index-ClcD9ViR.js";import"./_commonjsHelpers-Cpj98o6Y.js";const ue={title:"Core Components/Chat Area/Action Bubble/Action Badge",tags:["autodocs"],parameters:{layout:"centered"}},c={name:"Incoming Voice Call",render:()=>e.jsx(n,{children:e.jsx(i,{icon:"phone_callback",label:"Incoming Voice Call"})})},s={name:"Outgoing Voice Call",render:()=>e.jsx(n,{children:e.jsx(i,{icon:"phone_outgoing",label:"Outgoing Voice Call"})})},d={name:"Voice Call Answered",render:()=>e.jsx(n,{children:e.jsx(i,{icon:"call",label:"Voice Call Answered"})})},t={name:"Voice Call Rejected",render:()=>e.jsx(n,{children:e.jsx(i,{icon:"call_end",label:"Voice Call Rejected"})})},C={name:"Missed Voice Call",render:()=>e.jsx(n,{children:e.jsx(i,{icon:"phone_missed",label:"Missed Voice Call",missed:!0})})},p={name:"Incoming Video Call",render:()=>e.jsx(n,{children:e.jsx(i,{icon:"videocam",label:"Incoming Video Call",videoDirection:"incoming"})})},m={name:"Outgoing Video Call",render:()=>e.jsx(n,{children:e.jsx(i,{icon:"videocam",label:"Outgoing Video Call",videoDirection:"outgoing"})})},g={name:"Video Call Answered",render:()=>e.jsx(n,{children:e.jsx(i,{icon:"videocam",label:"Video Call Answered"})})},b={name:"Video Call Rejected",render:()=>e.jsx(n,{children:e.jsx(i,{icon:"videocam_off",label:"Video Call Rejected"})})},u={name:"Missed Video Call",render:()=>e.jsx(n,{children:e.jsx(i,{icon:"missed_video_call",label:"Missed Video Call",missed:!0})})},v={name:"All Call Actions",render:()=>e.jsxs(n,{width:400,children:[e.jsx(i,{icon:"phone_callback",label:"Incoming Voice Call"}),e.jsx(i,{icon:"phone_outgoing",label:"Outgoing Voice Call"}),e.jsx(i,{icon:"call",label:"Voice Call Answered"}),e.jsx(i,{icon:"call_end",label:"Voice Call Rejected"}),e.jsx(i,{icon:"phone_missed",label:"Missed Voice Call",missed:!0}),e.jsx(i,{icon:"videocam",label:"Incoming Video Call",videoDirection:"incoming"}),e.jsx(i,{icon:"videocam",label:"Outgoing Video Call",videoDirection:"outgoing"}),e.jsx(i,{icon:"videocam",label:"Video Call Answered"}),e.jsx(i,{icon:"videocam_off",label:"Video Call Rejected"}),e.jsx(i,{icon:"missed_video_call",label:"Missed Video Call",missed:!0})]})},V={parameters:{controls:{disable:!0},layout:"fullscreen"},render:()=>e.jsxs("div",{style:{padding:"var(--space-8)",maxWidth:1200,margin:"0 auto"},children:[e.jsx(h,{title:"HTML Structure",children:e.jsx(Ce,{language:"HTML",code:`<!-- Call Action Badge (centered, no lines) -->
...
}`,...(ee=(Y=v.parameters)==null?void 0:Y.docs)==null?void 0:ee.source}}};var ie,oe,ae;V.parameters={...V.parameters,docs:{...(ie=V.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    },
...
}`,...(ae=(oe=V.parameters)==null?void 0:oe.docs)==null?void 0:ae.source}}};var ne,le,re,ce,se;r.parameters={...r.parameters,docs:{...(ne=r.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  parameters: {
    docs: {
      disable: true
    }
  }
}`,...(re=(le=r.parameters)==null?void 0:le.docs)==null?void 0:re.source},description:{story:"Interactive playground.",...(se=(ce=r.parameters)==null?void 0:ce.docs)==null?void 0:se.description}}};const ve=["IncomingVoiceCall","OutgoingVoiceCall","VoiceCallAnswered","VoiceCallRejected","MissedVoiceCall","IncomingVideoCall","OutgoingVideoCall","VideoCallAnswered","VideoCallRejected","MissedVideoCall","AllCallActions","Usage","Playground"];export{v as AllCallActions,p as IncomingVideoCall,c as IncomingVoiceCall,u as MissedVideoCall,C as MissedVoiceCall,m as OutgoingVideoCall,s as OutgoingVoiceCall,r as Playground,V as Usage,g as VideoCallAnswered,b as VideoCallRejected,d as VoiceCallAnswered,t as VoiceCallRejected,ve as __namedExportsOrder,ue as default};
