import{j as e}from"./jsx-runtime-BYYWji4R.js";import{b as K,S as m,R as p,I as a,D as n,e as v,d as l,M as s,P as L,f as A,g as J,h as Q,j as d,U as T}from"./_shared-gpEOlAGR.js";import"./index-ClcD9ViR.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./SearchBar-C2XVB5CY.js";/* empty css                  */const $={title:"Core Components/Message Composer/Multi Attachments/Types/Files",tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`**File attachment — all states.** Documents (PDF / DOC / XLS) across the
composer (loading → default → hover → remove → error), delivered as stacked
file cards (single, multiple, uploading, failed), and as a search list.`}}}},r={name:"In Composer",parameters:{controls:{disable:!0}},render:()=>e.jsxs("div",{style:{padding:"var(--cometchat-spacing-6)",display:"flex",flexDirection:"column",gap:"var(--cometchat-spacing-10)"},children:[e.jsx(K,{}),e.jsx(m,{title:"States",children:e.jsxs(p,{gap:16,children:[e.jsx(a,{label:"Loading",children:e.jsx(n,{badge:"loading",name:"Deck.pdf",type:"pdf",meta:"PDF · 6.1 MB"})}),e.jsx(a,{label:"Default",children:e.jsx(n,{badge:"none",name:"Deck.pdf",type:"pdf",meta:"PDF · 6.1 MB"})}),e.jsx(a,{label:"Hover",children:e.jsx(n,{badge:"hover",name:"Deck.pdf",type:"pdf",meta:"PDF · 6.1 MB"})}),e.jsx(a,{label:"Remove",children:e.jsx(n,{badge:"remove",name:"Deck.pdf",type:"pdf",meta:"PDF · 6.1 MB"})}),e.jsx(a,{label:"Error",children:e.jsx(n,{badge:"error",name:"Deck.pdf",type:"pdf",meta:"PDF · 6.1 MB"})})]})}),e.jsx(m,{title:"File types",children:e.jsxs(p,{gap:16,children:[e.jsx(a,{label:"PDF",children:e.jsx(n,{badge:"hover",name:"Q3-Report.pdf",type:"pdf",meta:"PDF · 2.4 MB"})}),e.jsx(a,{label:"DOC",children:e.jsx(n,{badge:"hover",name:"Notes.docx",type:"doc",meta:"DOC · 340 KB"})}),e.jsx(a,{label:"XLS",children:e.jsx(n,{badge:"hover",name:"Budget.xlsx",type:"xls",meta:"XLS · 812 KB"})})]})})]})},c={name:"In Message",parameters:{controls:{disable:!0}},render:()=>e.jsxs("div",{style:{padding:"var(--cometchat-spacing-6)"},children:[e.jsx(K,{}),e.jsxs(p,{gap:24,children:[["sent","received"].map(t=>e.jsxs(v,{width:320,children:[e.jsx(a,{label:`${t} · single`,children:e.jsx(l,{variant:t,children:e.jsx(s,{variant:t,files:[{kind:"pdf",name:"Q3-Report.pdf",meta:"12 Jun · 2.4 MB"}]})})}),e.jsx(a,{label:`${t} · multiple (separate bubbles)`,children:e.jsxs(l,{variant:t,children:[e.jsx(s,{variant:t,files:[{kind:"pdf",name:"Contract.pdf",meta:"12 Jun · 1.2 MB"}],showMeta:!1}),e.jsx(s,{variant:t,files:[{kind:"doc",name:"Notes.docx",meta:"12 Jun · 340 KB"}],showMeta:!1}),e.jsx(s,{variant:t,files:[{kind:"xls",name:"Budget.xlsx",meta:"12 Jun · 812 KB"}]})]})})]},t)),e.jsxs(v,{width:320,children:[e.jsx(a,{label:"uploading",children:e.jsx(l,{variant:"sent",children:e.jsx(s,{variant:"sent",state:"uploading",files:[{kind:"pdf",name:"Deck.pdf",meta:"6.1 MB"}]})})}),e.jsx(a,{label:"failed",children:e.jsx(l,{variant:"sent",children:e.jsx(s,{variant:"sent",state:"failed",files:[{kind:"pdf",name:"Deck.pdf",meta:"6.1 MB"}]})})})]})]})]})},i={name:"In Search",parameters:{controls:{disable:!0}},render:()=>e.jsx("div",{style:{padding:"var(--cometchat-spacing-6)"},children:e.jsx(m,{title:"Document results",children:e.jsxs(L,{children:[e.jsx(A,{value:"review",active:"Documents"}),e.jsx(J,{}),e.jsx(Q,{children:"Documents"}),e.jsx(d,{name:"Q3-Report.pdf",meta:"2.4 MB",type:"pdf",from:"You"}),e.jsx(d,{name:"Notes.docx",meta:"340 KB",type:"doc",from:"Priya"}),e.jsx(d,{name:"Budget.xlsx",meta:"812 KB",type:"xls",from:"Marketing"})]})})})},o={parameters:{controls:{disable:!0},layout:"fullscreen"},render:()=>e.jsx(T,{composed:[{name:"DocumentPreview",desc:"Composer file chip — white app-tile icon + name + meta, single-slot corner badge."},{name:"FileTypeIcon",desc:"Per-type document glyph (PDF / DOC / XLS / PPT / ZIP / TXT / generic)."},{name:"MultiAttachmentBubble",desc:"Delivered file card; multiple documents stack as separate bubbles."},{name:"SearchBar",desc:"Design-system search input used by the Documents filter."},{name:"DocumentResult",desc:"Search list row — icon tile, name, size · sharer, download."}],html:`<!-- Composer preview chip -->
...
}`})};var u,f,h,b,g;r.parameters={...r.parameters,docs:{...(u=r.parameters)==null?void 0:u.docs,source:{originalSource:`{
  name: "In Composer",
  parameters: {
    controls: {
      disable: true
...
}`,...(h=(f=r.parameters)==null?void 0:f.docs)==null?void 0:h.source},description:{story:"Composer preview — every badge state, plus the three file types.",...(g=(b=r.parameters)==null?void 0:b.docs)==null?void 0:g.description}}};var x,D,y,w,_;c.parameters={...c.parameters,docs:{...(x=c.parameters)==null?void 0:x.docs,source:{originalSource:`{
  name: "In Message",
  parameters: {
    controls: {
      disable: true
...
}`,...(y=(D=c.parameters)==null?void 0:D.docs)==null?void 0:y.source},description:{story:"Delivered — single card, several stacked, uploading and failed.",...(_=(w=c.parameters)==null?void 0:w.docs)==null?void 0:_.description}}};var M,j,B,k,S;i.parameters={...i.parameters,docs:{...(M=i.parameters)==null?void 0:M.docs,source:{originalSource:`{
  name: "In Search",
  parameters: {
    controls: {
      disable: true
...
}`,...(B=(j=i.parameters)==null?void 0:j.docs)==null?void 0:B.source},description:{story:"In search — the Documents filter renders a file list.",...(S=(k=i.parameters)==null?void 0:k.docs)==null?void 0:S.description}}};var P,I,C,R,F;o.parameters={...o.parameters,docs:{...(P=o.parameters)==null?void 0:P.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    },
...
}`,...(C=(I=o.parameters)==null?void 0:I.docs)==null?void 0:C.source},description:{story:"Usage — HTML structure + token CSS.",...(F=(R=o.parameters)==null?void 0:R.docs)==null?void 0:F.description}}};const z=["InComposer","InMessage","InSearch","Usage"];export{r as InComposer,c as InMessage,i as InSearch,o as Usage,z as __namedExportsOrder,$ as default};
