...
}`})};var M,_,D;u.parameters={...u.parameters,docs:{...(M=u.parameters)==null?void 0:M.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
...
}`,...(D=(_=u.parameters)==null?void 0:_.docs)==null?void 0:D.source}}};var A,R,T;v.parameters={...v.parameters,docs:{...(A=v.parameters)==null?void 0:A.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    }
...
}`,...(O=(G=d.parameters)==null?void 0:G.docs)==null?void 0:O.source},description:{story:"Every card type in its default state, desktop and mobile.",...(K=($=d.parameters)==null?void 0:$.docs)==null?void 0:K.description}}};var V,q,z,N,Q;m.parameters={...m.parameters,docs:{...(V=m.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: "Document Types",
  parameters: {
    controls: {
      disable: true
...
}`,...(z=(q=m.parameters)==null?void 0:q.docs)==null?void 0:z.source},description:{story:"Documents come in several file-type variants.",...(Q=(N=m.parameters)==null?void 0:N.docs)==null?void 0:Q.description}}};var X,Z,H,Y,J;p.parameters={...p.parameters,docs:{...(X=p.parameters)==null?void 0:X.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    },
...
}`,...(H=(Z=p.parameters)==null?void 0:Z.docs)==null?void 0:H.source},description:{story:"Usage — HTML structure + token CSS.",...(J=(Y=p.parameters)==null?void 0:Y.docs)==null?void 0:J.description}}};const Me=["Document","Image","Video","Audio","Overview","FileTypes","Usage"];export{g as Audio,u as Document,m as FileTypes,v as Image,d as Overview,p as Usage,x as Video,Me as __namedExportsOrder,Ce as default};
