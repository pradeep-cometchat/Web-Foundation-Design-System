...
- Arrow: 6px triangle pointing down, same color as bg`}}},argTypes:{emoji:{control:"text",description:"The emoji that was reacted with."},names:{control:"object",description:"List of names who reacted."},maxVisible:{control:{type:"number",min:1,max:10},description:"Max names shown before +N."},label:{control:"text",description:"Label text below names."},showArrow:{control:"boolean",description:"Whether to show the bottom arrow."}}},r={args:{emoji:"😍",names:["George Alan","Pourav Raj","Alice","Bob","Charlie","Dave","Eve"],maxVisible:2,label:"reacted",showArrow:!0}},n={args:{emoji:"👍",names:["George Alan"],maxVisible:2,label:"reacted",showArrow:!0}},o={args:{emoji:"❤️",names:["George Alan","Pourav Raj"],maxVisible:2,label:"reacted",showArrow:!0}},s={args:{emoji:"😂",names:["Alice","Bob","Charlie","Dave","Eve","Frank","Grace","Heidi","Ivan","Judy"],maxVisible:3,label:"reacted",showArrow:!0}},t={args:{emoji:"🔥",names:["George Alan","Pourav Raj","Alice"],maxVisible:2,label:"reacted",showArrow:!1}},i={parameters:{layout:"padded"},render:()=>e.jsxs("div",{style:{display:"flex",gap:24,flexWrap:"wrap",justifyContent:"center",alignItems:"flex-start",padding:40},children:[e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:8},children:[e.jsx("div",{style:c,children:"Single"}),e.jsx(a,{emoji:"👍",names:["George Alan"]})]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:8},children:[e.jsx("div",{style:c,children:"Two names"}),e.jsx(a,{emoji:"❤️",names:["George Alan","Pourav Raj"]})]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:8},children:[e.jsx("div",{style:c,children:"Overflow (+5)"}),e.jsx(a,{emoji:"😍",names:["George Alan","Pourav Raj","Alice","Bob","Charlie","Dave","Eve"]})]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:8},children:[e.jsx("div",{style:c,children:"Different emoji"}),e.jsx(a,{emoji:"🔥",names:["Alice","Bob","Charlie"],maxVisible:3})]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:8},children:[e.jsx("div",{style:c,children:"No arrow"}),e.jsx(a,{emoji:"😂",names:["George Alan","Pourav Raj"],showArrow:!1})]})]})},l={args:{emoji:"😍",names:["George Alan","Pourav Raj","Alice","Bob","Charlie","Dave","Eve"],maxVisible:2,label:"reacted",showArrow:!0},parameters:{docs:{disable:!0}}},c={fontSize:11,fontWeight:600,textTransform:"uppercase",letterSpacing:"0.06em",color:"var(--color-neutral-500, #535862)"};var x,f,h,v,j;r.parameters={...r.parameters,docs:{...(x=r.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    emoji: "😍",
...
}`,...(h=(f=r.parameters)==null?void 0:f.docs)==null?void 0:h.source},description:{story:"Default state — exact match to Figma node 4043:476245.",...(j=(v=r.parameters)==null?void 0:v.docs)==null?void 0:j.description}}};var w,y,b,A,R;n.parameters={...n.parameters,docs:{...(w=n.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    emoji: "👍",
    names: ["George Alan"],
    maxVisible: 2,
...
}`,...(T=(L=t.parameters)==null?void 0:L.docs)==null?void 0:T.source},description:{story:"Without arrow.",...(q=(W=t.parameters)==null?void 0:W.docs)==null?void 0:q.description}}};var M,F,k,O,H;i.parameters={...i.parameters,docs:{...(M=i.parameters)==null?void 0:M.docs,source:{originalSource:`{
  parameters: {
    layout: "padded"
  },
  render: () => <div style={{
...
}`,...(k=(F=i.parameters)==null?void 0:F.docs)==null?void 0:k.source},description:{story:"All variants side by side.",...(H=(O=i.parameters)==null?void 0:O.docs)==null?void 0:H.description}}};var J,$,z,K,Q;l.parameters={...l.parameters,docs:{...(J=l.parameters)==null?void 0:J.docs,source:{originalSource:`{
  args: {
    emoji: "😍",
    names: ["George Alan", "Pourav Raj", "Alice", "Bob", "Charlie", "Dave", "Eve"],
    maxVisible: 2,
