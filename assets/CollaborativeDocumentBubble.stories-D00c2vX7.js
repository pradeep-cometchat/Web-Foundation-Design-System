import{j as e}from"./jsx-runtime-BYYWji4R.js";/* empty css                    */import"./index-ClcD9ViR.js";import"./_commonjsHelpers-Cpj98o6Y.js";const K={title:"Core Components/Chat Bubbles/Collaborative Document Bubble",tags:["autodocs"],parameters:{layout:"centered"}},s={name:"Sent — Default",parameters:{docs:{description:{story:"Outgoing collaborative document bubble with read receipt."}}},render:()=>e.jsx(h,{children:e.jsx(l,{variant:"sent",status:"read",time:"4:56 pm"})})},d={name:"Sent — Delivered",parameters:{docs:{description:{story:"Outgoing collaborative document bubble with delivered status."}}},render:()=>e.jsx(h,{children:e.jsx(l,{variant:"sent",status:"delivered",time:"4:56 pm"})})},b={name:"Sent — Sent",parameters:{docs:{description:{story:"Outgoing collaborative document bubble with sent status."}}},render:()=>e.jsx(h,{children:e.jsx(l,{variant:"sent",status:"sent",time:"4:56 pm"})})},p={name:"Received — Default",parameters:{docs:{description:{story:"Incoming collaborative document bubble."}}},render:()=>e.jsx(h,{children:e.jsx(l,{variant:"received",time:"4:56 pm"})})},u={name:"All Variants",parameters:{layout:"padded"},render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--space-6)",width:340,padding:"var(--space-4)"},children:[e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--space-2)"},children:[e.jsx(m,{children:"Sent — Read"}),e.jsx(l,{variant:"sent",status:"read",time:"4:56 pm"})]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--space-2)"},children:[e.jsx(m,{children:"Received"}),e.jsx(l,{variant:"received",time:"4:56 pm"})]})]})},v={parameters:{controls:{disable:!0},layout:"fullscreen"},render:()=>e.jsxs("div",{style:{padding:"var(--space-8)",maxWidth:1200,margin:"0 auto"},children:[e.jsx(o,{title:"HTML Structure",children:e.jsx(g,{language:"HTML",code:`<!-- Sent Collaborative Document Bubble -->
...
</div>`})}),e.jsx(o,{title:"CSS (Foundation Variables)",children:e.jsx(g,{language:"CSS",code:`.collab-doc-bubble {
  padding: 0;
  overflow: hidden;
  min-width: 260px;
}
...
.chat-bubble-wrapper--received .collab-doc-bubble__action-text {
  color: var(--color-icon-highlight-primary);
}`})}),e.jsx(o,{title:"Variants",children:e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(280px, 1fr))",gap:"var(--space-3)"},children:[e.jsx(t,{title:"Sent — Default",description:"Purple background. White document icon, white title/description, white 'Open Document' button. Green read receipt."}),e.jsx(t,{title:"Sent — Delivered",description:"Same as default with double check in muted white indicating delivery."}),e.jsx(t,{title:"Sent — Sent",description:"Same as default with single check in muted white indicating sent."}),e.jsx(t,{title:"Received — Default",description:"Light gray background. Purple document icon, dark title, gray description, purple 'Open Document' button. No receipt."})]})}),e.jsx(o,{title:"Anatomy",children:e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(280px, 1fr))",gap:"var(--space-3)"},children:[e.jsx(t,{title:"Preview Image",description:"Document preview thumbnail at the top with rounded corners. Shows collaborative editing with user cursors."}),e.jsx(t,{title:"Document Icon",description:"Material icon 'description' (filled, 24px). White on sent, purple on received."}),e.jsx(t,{title:"Title",description:"'Collaborative Document' — semibold, primary size."}),e.jsx(t,{title:"Description",description:"Truncated description text — 'Open document to edit content toge...' in muted color."}),e.jsx(t,{title:"Separator",description:"Full-width 1px line dividing info from action."}),e.jsx(t,{title:"Action Button",description:"'Open Document' — semibold, centered. White on sent, purple on received."}),e.jsx(t,{title:"Timestamp + Receipt",description:"Bottom-right aligned. Time + read receipt (sent only)."})]})}),e.jsx(o,{title:"Design Tokens",children:e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(280px, 1fr))",gap:"var(--space-3)"},children:[e.jsx(t,{title:"Sent Background",description:"var(--color-send-bubble-bg) — Primary purple"}),e.jsx(t,{title:"Received Background",description:"var(--color-received-bubble-bg) — Light gray"}),e.jsx(t,{title:"Preview Background",description:"var(--color-bg-02) — Subtle gray for the preview area"}),e.jsx(t,{title:"Sent Separator",description:"rgba(255, 255, 255, 0.2) — Semi-transparent white"}),e.jsx(t,{title:"Received Separator",description:"rgba(0, 0, 0, 0.12) — Semi-transparent black"}),e.jsx(t,{title:"Action Text (Sent)",description:"var(--color-static-white)"}),e.jsx(t,{title:"Action Text (Received)",description:"var(--color-icon-highlight-primary) — Purple"}),e.jsx(t,{title:"Border Radius",description:"var(--radius-xl) — 12px uniform on all corners"})]})}),e.jsx(o,{title:"Figma Reference",children:e.jsx(t,{title:"Source File",description:"Web Desktop — Chat UI Kits → Collaborative Document section (node 4104:458701)"})})]})};function l({variant:a,status:i,time:n}){const r=a==="sent";return e.jsx("div",{className:`chat-bubble-wrapper chat-bubble-wrapper--${a}`,children:e.jsxs("div",{className:"chat-bubble-body",style:{padding:0,overflow:"hidden",minWidth:260},children:[e.jsx("div",{style:{margin:"var(--space-2)",marginBottom:0,borderRadius:"var(--radius-md)",overflow:"hidden",background:"var(--color-static-white)",aspectRatio:"4 / 3",display:"flex",alignItems:"center",justifyContent:"center",position:"relative"},children:e.jsx(V,{})}),e.jsxs("div",{style:{display:"flex",alignItems:"flex-start",gap:"var(--space-2)",padding:"var(--space-3) var(--space-3) var(--space-2)"},children:[e.jsx("span",{style:{flexShrink:0,color:r?"var(--color-static-white)":"var(--color-icon-highlight-primary)",display:"flex"},children:e.jsxs("svg",{width:"24",height:"24",viewBox:"0 0 20.3865 21.4032",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[e.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M0 3.14748C0 1.40917 1.40918 0 3.14749 0H13.8489C15.5873 0 16.9964 1.40918 16.9964 3.14749V8.5388C16.9964 8.70329 16.932 8.86125 16.8171 8.97886L12.75 13.1389L6.93259 18.7101C6.81541 18.8223 6.65943 18.8849 6.49719 18.8849H3.14749C1.40918 18.8849 0 17.4757 0 15.7374V3.14748ZM7.2393 2.95166C6.783 2.95166 6.41309 3.32157 6.41309 3.77788C6.41309 4.23418 6.783 4.60409 7.2393 4.60409H13.2195C13.6758 4.60409 14.0457 4.23418 14.0457 3.77788C14.0457 3.32157 13.6758 2.95166 13.2195 2.95166H7.2393ZM3.77641 6.41455C3.3201 6.41455 2.9502 6.78446 2.9502 7.24077C2.9502 7.69707 3.3201 8.06698 3.77641 8.06698H13.2189C13.6752 8.06698 14.0451 7.69707 14.0451 7.24077C14.0451 6.78446 13.6752 6.41455 13.2189 6.41455H3.77641ZM3.77641 9.87598C3.3201 9.87598 2.9502 10.2459 2.9502 10.7022C2.9502 11.1585 3.3201 11.5284 3.77641 11.5284H11.3304C11.7867 11.5284 12.1566 11.1585 12.1566 10.7022C12.1566 10.2459 11.7867 9.87598 11.3304 9.87598H3.77641Z",fill:"currentColor"}),e.jsx("path",{d:"M19.1275 10.3341C18.6359 9.84242 17.8387 9.84242 17.3471 10.3341L9.41276 18.2684C9.3622 18.319 9.3294 18.3846 9.31929 18.4553L8.95206 21.0259C8.9209 21.244 9.10785 21.431 9.32596 21.3998L11.8965 21.0326C11.9673 21.0225 12.0329 20.9897 12.0835 20.9391L20.0178 13.0048C20.5095 12.5132 20.5095 11.716 20.0178 11.2243L19.1275 10.3341Z",fill:"currentColor"})]})}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:2,minWidth:0},children:[e.jsx("span",{style:{fontSize:"var(--font-size-2)",fontWeight:"var(--font-weight-semibold)",fontFamily:"var(--font-family-body)",lineHeight:"var(--line-height-body)",color:r?"var(--color-static-white)":"var(--color-text-primary)"},children:"Collaborative Document"}),e.jsx("span",{style:{fontSize:"var(--font-size-1)",fontFamily:"var(--font-family-body)",lineHeight:"var(--line-height-caption-1)",color:r?"rgba(255, 255, 255, 0.7)":"var(--color-text-tertiary)",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:"Open document to edit content toge..."})]})]}),e.jsx("div",{style:{height:1,background:r?"rgba(255, 255, 255, 0.2)":"rgba(0, 0, 0, 0.12)"}}),e.jsx("div",{style:{padding:"var(--space-3) var(--space-3)",textAlign:"center"},children:e.jsx("span",{style:{fontSize:"var(--font-size-2)",fontWeight:"var(--font-weight-semibold)",fontFamily:"var(--font-family-body)",color:r?"var(--color-static-white)":"var(--color-icon-highlight-primary)",cursor:"pointer"},children:"Open Document"})}),e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"flex-end",gap:"var(--space-1)",padding:"0 var(--space-3) var(--space-2)"},children:[e.jsx("span",{className:"chat-bubble-meta-time",children:n}),r&&i&&e.jsx(F,{status:i})]})]})})}function F({status:a}){const n=a==="read"?"var(--color-message-seen)":"rgba(255, 255, 255, 0.7)";return a==="sent"?e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:e.jsx("path",{d:"M3.5 8.5L6.5 11.5L12.5 4.5",stroke:n,strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})}):e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[e.jsx("path",{d:"M2 8.5L5 11.5L11 4.5",stroke:n,strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"}),e.jsx("path",{d:"M5.5 8.5L8.5 11.5L14.5 4.5",stroke:n,strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})]})}function V(){return e.jsxs("svg",{width:"100%",height:"100%",viewBox:"0 0 280 210",fill:"none",xmlns:"http://www.w3.org/2000/svg",style:{background:"#f5f5f5"},children:[e.jsx("rect",{x:"60",y:"20",width:"160",height:"180",rx:"4",fill:"#e8e8e8"}),e.jsx("rect",{x:"75",y:"35",width:"50",height:"50",rx:"4",fill:"#888"}),e.jsx("text",{x:"92",y:"68",fontSize:"24",fontWeight:"bold",fill:"white",children:"T"}),e.jsx("rect",{x:"135",y:"35",width:"70",height:"25",rx:"3",fill:"#666"}),e.jsx("rect",{x:"135",y:"68",width:"70",height:"3",rx:"1.5",fill:"#999"}),e.jsx("rect",{x:"135",y:"76",width:"60",height:"3",rx:"1.5",fill:"#999"}),e.jsx("rect",{x:"135",y:"84",width:"70",height:"3",rx:"1.5",fill:"#999"}),e.jsx("rect",{x:"75",y:"100",width:"130",height:"3",rx:"1.5",fill:"#bbb"}),e.jsx("rect",{x:"75",y:"110",width:"130",height:"3",rx:"1.5",fill:"#bbb"}),e.jsx("rect",{x:"75",y:"120",width:"130",height:"3",rx:"1.5",fill:"#bbb"}),e.jsx("rect",{x:"75",y:"130",width:"130",height:"3",rx:"1.5",fill:"#bbb"}),e.jsx("rect",{x:"75",y:"140",width:"130",height:"3",rx:"1.5",fill:"#bbb"}),e.jsx("rect",{x:"75",y:"150",width:"130",height:"3",rx:"1.5",fill:"#bbb"}),e.jsx("rect",{x:"75",y:"160",width:"130",height:"3",rx:"1.5",fill:"#bbb"}),e.jsx("rect",{x:"75",y:"170",width:"100",height:"3",rx:"1.5",fill:"#bbb"}),e.jsx("polygon",{points:"185,40 188,52 192,48",fill:"#f87171"}),e.jsx("rect",{x:"180",y:"28",width:"40",height:"16",rx:"4",fill:"#fecaca"}),e.jsx("text",{x:"188",y:"39",fontSize:"8",fill:"#dc2626",fontWeight:"500",children:"Sarah"}),e.jsx("polygon",{points:"62,105 65,117 69,113",fill:"#34d399"}),e.jsx("rect",{x:"55",y:"115",width:"38",height:"16",rx:"4",fill:"#d1fae5"}),e.jsx("text",{x:"62",y:"126",fontSize:"8",fill:"#059669",fontWeight:"500",children:"Jason"}),e.jsx("polygon",{points:"210,135 213,147 217,143",fill:"#a78bfa"}),e.jsx("rect",{x:"205",y:"145",width:"50",height:"16",rx:"4",fill:"#ede9fe"}),e.jsx("text",{x:"212",y:"156",fontSize:"8",fill:"#7c3aed",fontWeight:"500",children:"Stephen"})]})}function h({children:a,width:i=340}){return e.jsx("div",{style:{width:i,display:"flex",flexDirection:"column",gap:"var(--space-4)",padding:"var(--space-4)",background:"var(--color-bg-01)",borderRadius:"var(--radius-xl)",border:"1px solid var(--color-border-default)"},children:a})}function m({children:a}){return e.jsx("span",{style:{fontSize:"var(--font-size-0)",fontWeight:"var(--font-weight-semibold)",color:"var(--color-text-tertiary)",textTransform:"uppercase",letterSpacing:"0.06em"},children:a})}function o({title:a,children:i}){return e.jsxs("div",{style:{marginBottom:"var(--space-6)"},children:[e.jsx("div",{style:{fontSize:"var(--font-size-1)",fontWeight:"var(--font-weight-semibold)",color:"var(--color-text-secondary)",textTransform:"uppercase",letterSpacing:"0.06em",marginBottom:"var(--space-2)",paddingBottom:"var(--space-2)",borderBottom:"1px solid var(--color-border-default)"},children:a}),i]})}function g({language:a,code:i}){return e.jsxs("div",{style:{border:"1px solid var(--color-border-default)",borderRadius:"var(--radius-xl)",overflow:"hidden",background:"var(--color-bg-02)"},children:[e.jsx("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"var(--space-2) var(--space-3)",borderBottom:"1px solid var(--color-border-default)",background:"var(--color-bg-03)"},children:e.jsx("span",{style:{fontSize:"var(--font-size-0)",fontWeight:"var(--font-weight-semibold)",letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--color-text-secondary)"},children:a})}),e.jsx("pre",{style:{margin:0,padding:"var(--space-3-5)",fontFamily:"var(--font-family-body)",fontSize:"var(--font-size-1)",lineHeight:1.6,color:"var(--color-text-primary)",overflowX:"auto"},children:e.jsx("code",{children:i})})]})}function t({title:a,description:i}){return e.jsxs("div",{style:{padding:"var(--space-3-5) var(--space-4)",border:"1px solid var(--color-border-default)",borderRadius:"var(--radius-xl)",background:"var(--color-bg-01)"},children:[e.jsx("strong",{style:{fontSize:"var(--font-size-2)",fontWeight:"var(--font-weight-semibold)",color:"var(--color-text-primary)",display:"block",marginBottom:"var(--space-1)"},children:a}),e.jsx("span",{style:{fontSize:"var(--font-size-1)",color:"var(--color-text-tertiary)",lineHeight:"var(--line-height-caption-1)"},children:i})]})}const c={parameters:{docs:{disable:!0}}};var x,f,w;s.parameters={...s.parameters,docs:{...(x=s.parameters)==null?void 0:x.docs,source:{originalSource:`{
  name: "Sent — Default",
  parameters: {
    docs: {
      description: {
...
}`,...(D=(C=b.parameters)==null?void 0:C.docs)==null?void 0:D.source}}};var k,R,z;p.parameters={...p.parameters,docs:{...(k=p.parameters)==null?void 0:k.docs,source:{originalSource:`{
...
}`,...(z=(R=p.parameters)==null?void 0:R.docs)==null?void 0:z.source}}};var B,W,L;u.parameters={...u.parameters,docs:{...(B=u.parameters)==null?void 0:B.docs,source:{originalSource:`{
  name: "All Variants",
  parameters: {
    layout: "padded"
  },
...
}`,...(L=(W=u.parameters)==null?void 0:W.docs)==null?void 0:L.source}}};var T,O,I;v.parameters={...v.parameters,docs:{...(T=v.parameters)==null?void 0:T.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    },
...
}`,...(I=(O=v.parameters)==null?void 0:O.docs)==null?void 0:I.source}}};var P,U,H,M,A;c.parameters={...c.parameters,docs:{...(P=c.parameters)==null?void 0:P.docs,source:{originalSource:`{
  parameters: {
    docs: {
      disable: true
    }
  }
}`,...(H=(U=c.parameters)==null?void 0:U.docs)==null?void 0:H.source},description:{story:"Interactive playground.",...(A=(M=c.parameters)==null?void 0:M.docs)==null?void 0:A.description}}};const J=["SentDefault","SentDelivered","SentSent","ReceivedDefault","AllVariants","Usage","Playground"];export{u as AllVariants,c as Playground,p as ReceivedDefault,s as SentDefault,d as SentDelivered,b as SentSent,v as Usage,J as __namedExportsOrder,K as default};
