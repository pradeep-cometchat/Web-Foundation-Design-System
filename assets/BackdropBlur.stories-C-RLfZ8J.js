import{j as r}from"./jsx-runtime-BYYWji4R.js";import{P as E,S as f}from"./Section-CigK6cgU.js";import{C as O}from"./Callout-BB-HyLdv.js";import{T as k}from"./TokenTable-BJA1pDSo.js";import{C as _}from"./CopyButton-CWX651uh.js";import"./index-ClcD9ViR.js";import"./_commonjsHelpers-Cpj98o6Y.js";const p=.6,b="#ffffff",u="#000000",y={sm:{size:"sm",blur:8,opacity:p,tint:{light:b,dark:u}},md:{size:"md",blur:16,opacity:p,tint:{light:b,dark:u}},lg:{size:"lg",blur:24,opacity:p,tint:{light:b,dark:u}},xl:{size:"xl",blur:40,opacity:p,tint:{light:b,dark:u}}},w=(e,a)=>{const n=e.replace("#",""),o=n.length===3?n.split("").map(c=>c+c).join(""):n,t=parseInt(o,16),i=t>>16&255,m=t>>8&255,s=t&255;return`rgba(${i}, ${m}, ${s}, ${a})`},j=["sm","md","lg","xl"],Y={title:"Foundation/Effects/Backdrop Blur",component:G,tags:["autodocs"],parameters:{layout:"fullscreen",themes:{themeOverride:"Light"},docs:{description:{component:`Backdrop blur creates a frosted-glass effect for panels, sheets, and
